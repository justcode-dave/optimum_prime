# coding=utf-8
"""
Manages model export tasks for various backends such as ONNX and TFLite.

The TasksManager class handles:
- Mapping tasks to model classes for different frameworks (PyTorch, TensorFlow, etc.)
- Registering export configurations for model types and tasks.
- Inferring tasks and frameworks from models.
- Determining the appropriate backend configurations for exporting models.

It also includes various utility functions for managing tasks, supported model types, and framework availability.
"""
