# coding=utf-8
"""
Utilities for preparing models for export.

This module contains various functions that handle:
- Extracting and preparing model subcomponents (e.g., encoder, decoder) for export to formats like ONNX.
- Supporting different architectures including transformer-based models, diffusion models, and others.
- Handling custom export configurations and architecture-specific processing.

It provides utility methods for working with frameworks such as PyTorch, TensorFlow, and Diffusers.
"""
