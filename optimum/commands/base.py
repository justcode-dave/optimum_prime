"""
This module defines the foundational classes for the Optimum command-line interface (CLI).

It provides:
- `CommandInfo`: A dataclass that holds metadata for commands.
- `BaseOptimumCLICommand`: An abstract base class for all CLI commands, handling argument parsing and subcommand 
  registration.
- `RootOptimumCLICommand`: A specific command class for the root of the Optimum CLI.

These classes establish the structure and mechanisms needed to define and register commands and subcommands for the CLI.
"""
